...
players_wallet = Keypair.from_private_key("Enter your wallet's private key here") # read it 
dealers_wallet = Keypair.from_private_key("Enter your wallet's private key here") # read it 
